...
export default function Game() {
  ...
  const [planets, setPlanets] = useState([
    ...
    { x: screenWidth / 2 + 200, y: screenHeight / 2 - 100, radius: initialPlanetRadius + 5, mass: 70, color: "#ff66cc", angle: 0, type: "alien2" },
  ]);
  ...
  useEffect(() => {
    ...
    function drawPlanet(planet, index) {
      ...
      if (score === 9 && index === (currentPlanetIndex + 1) % planets.length) {
    ...
    function update() {
      ...
      updatedPlanets[currentPlanetIndex].angle += 0.02;
